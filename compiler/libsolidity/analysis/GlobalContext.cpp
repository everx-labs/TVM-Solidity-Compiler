...
m_magicVariables(vector<shared_ptr<MagicVariableDeclaration const>>{
	...
	make_shared<MagicVariableDeclaration>("logtvm", make_shared<FunctionType>(strings{"bytes32"}, strings{}, FunctionType::Kind::LogTVM,false, StateMutability::Pure)),
	make_shared<MagicVariableDeclaration>("msg", make_shared<MagicType>(MagicType::Kind::Message)),
	make_shared<MagicVariableDeclaration>("tvm", make_shared<MagicType>(MagicType::Kind::TVM)),
	...
	make_shared<MagicVariableDeclaration>("require", make_shared<FunctionType>(strings{"bool", "uint16"}, strings{}, FunctionType::Kind::Require, false, StateMutability::Pure)),
