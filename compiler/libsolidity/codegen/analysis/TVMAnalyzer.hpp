...
class BaseAnalyzer: public ASTConstVisitor {
public:
	/// @param _errorReporter provides the error logging functionality.
	explicit BaseAnalyzer(langutil::ErrorReporter& _errorReporter):
...
class TVMAnalyzer: public BaseAnalyzer {
public:
	TVMAnalyzer(langutil::ErrorReporter& _errorReporter):
...
class TVMAnalyzerFlag128: public BaseAnalyzer {
public:
	TVMAnalyzerFlag128(langutil::ErrorReporter& _errorReporter):
		BaseAnalyzer{_errorReporter} {}
...
class ExtraFlagAnalyzer: public BaseAnalyzer {
public:
	ExtraFlagAnalyzer(langutil::ErrorReporter& _errorReporter):
		BaseAnalyzer{_errorReporter} {}
